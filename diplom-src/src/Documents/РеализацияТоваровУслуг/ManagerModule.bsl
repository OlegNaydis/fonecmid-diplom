...
Процедура ВывестиУслуги(ДанныеДокументов, ТабличныйДокумент, Макет)
	...
	СуммаПрописью = ЧислоПрописью(СуммаУслуг,"Л=ru_RU"," рубль, рубля, рублей, м, копейка, копейки, копеек, ж, 2");
	ДанныеПечати.Вставить("ИтоговаяСтрока", "Итого выполнено работ на сумму:");
